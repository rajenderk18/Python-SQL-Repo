...
root = tk.Tk()
root.title('HRA\'s Excel File Creator for 3M/UB04')
root.resizable(0, 0)
...
label1 = tk.Label(root, text='HRA\'s Excel File Creator for 3M/UB04', bg='lightsteelblue2')
...
labelName = tk.Label(root, text='File Name: ', width = 250, bg='lightsteelblue2')
labelName.config(font=('helvetica', 12))
canvas1.create_window(150, 160, window=labelName)

fileName = tk.StringVar(root, value='Same as folder name')
textboxName = tk.Entry(root, textvariable = fileName, state='disabled')
